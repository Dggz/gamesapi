...
class ReminderDetailViewSet(generics.RetrieveUpdateDestroyAPIView):
    queryset = Reminder.objects.all()
    serializer_class = ReminderSerializer
...
class ApiRoot(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        return Response({
            ...
            'reminders': reverse(ReminderViewSet.name, request=request)
        })
