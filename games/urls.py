...
urlpatterns = [
    ...
    url(r'^reminders/$', views.ReminderViewSet.as_view(), name=views.ReminderViewSet.name),
    url(r'^reminders/(?P<pk>[0-9]+)/$', views.ReminderDetailViewSet.as_view(), name=views.ReminderDetailViewSet.name),
    # url(r'^users/(?P<pk>[0-9]+)/$', views.UserDetailViewSet.as_view(), name=views.UserDetailViewSet.name),
